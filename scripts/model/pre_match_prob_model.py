...
# DATA_DIR = Path("data-api-football")
...
#     MODEL_PATH = DATA_DIR / "prematch_logreg_model.pkl"
#     FEATURES_PATH = DATA_DIR / "prematch_model_features.pkl"
#     joblib.dump(model, MODEL_PATH)
#     joblib.dump(X_full.columns.tolist(), FEATURES_PATH)
#     print("Saved trained model to:", MODEL_PATH)
#     print("Saved model feature columns to:", FEATURES_PATH)
